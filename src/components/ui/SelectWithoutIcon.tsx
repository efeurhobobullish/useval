  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative mt-1">
        <select
          {...props}
          className={`px-4 h-11 w-full rounded-lg text-sm border border-line focus:border-primary focus:ring-4 focus:ring-primary/10 read-only:opacity-60 read-only:focus:ring-0 read-only:focus:border-line appearance-none  ${props.className}`}
        >
